...
def main():
    ap = argparse.ArgumentParser(
        description="Download LROC NAC South Pole Controlled Average Mosaic tiles (NAC_POLE_SOUTH_CM_AVG_1mpp)."
    )
    ap.add_argument("--out", type=Path, default=Path("data/NAC_POLE_SOUTH_CM_AVG_1mpp"), help="Output directory")
    ap.add_argument(
        "--ext",
        nargs="+",
        default=["tif"],
